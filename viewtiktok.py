...
\033[1;37m║ ╚═╝  ╚═╝╚═════╝    ╚═╝        ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝  ║
\033[1;34m╠═════════════════════════════════════════════════════════════════╣
\033[1;32m║➢ Author   : Buy - TOOL                                         ║
\033[1;36m║➢ Facebook  : https://www.facebook.com/danghoangbaohuy.milo     ║
\033[1;31m║➣ Zalo  : https://zalo.me/0372768928                            ║
\033[1;33m║➣ Website  : https://www.tiktok.com/@danghoangbaohuy.milo       ║
\033[1;34m╚═════════════════════════════════════════════════════════════════╝"""
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(f'{do}[{vang}BUY - TOOL{do}] {do}[{xanh_la}BUFF VIEW SUCCESS{do}] {do}{xanh_duong}+: {trang}{success}{do} View')
                    success += 1
                    _lock.release()
            except:
...
if __name__ == "__main__": 
    ...
    print(banner)
    try:
        link = 'https://vt.tiktok.com/ZSFcgU48B/' #os.getenv("url") #input(f'{do}[{trang}{kt_code}{do}] {xanh_la}INPUT LINK VIDEO: {trang}')
        print(f'{trang}- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -')
        __aweme_id = str(
